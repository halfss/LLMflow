...
import numpy as np
from utils.mytorch import torch_gc
...
class LocalDocQA:
    ...
    def get_knowledge_based_answer(self, query, vs_path, chat_history=[], streaming: bool = False):
        vector_store = FAISS.load_local(vs_path, self.embeddings)
        ...
        input_data = {
                ...
                "data": {"context": context, "question": query}
                }

        responses_message = self.llm.llmchat(input_data)
        responses_message['source_documents'] = source_documents
